...
type ToggleCloseProps = { open: boolean; setOpen: (v: boolean) => void };
  ...
  return (
    <div className="flex-1 bg-gray-50 dark:bg-gray-950 p-6 overflow-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {[
          { icon: DollarSign, label: "Total Sales", value: "$24,567", change: "+12% from last month", bg: "bg-blue-50 dark:bg-blue-900/20", color: "text-blue-600 dark:text-blue-400" },
          { icon: Users, label: "Active Users", value: "1,234", change: "+5% from last week", bg: "bg-green-50 dark:bg-green-900/20", color: "text-green-600 dark:text-green-400" },
          { icon: ShoppingCart, label: "Orders", value: "456", change: "+8% from yesterday", bg: "bg-purple-50 dark:bg-purple-900/20", color: "text-purple-600 dark:text-purple-400" },
          { icon: Package, label: "Products", value: "89", change: "+3 new this week", bg: "bg-orange-50 dark:bg-orange-900/20", color: "text-orange-600 dark:text-orange-400" },
        ].map(({ icon: Icon, label, value, change, bg, color }, i) => (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-6 shadow-sm">
            ...
            <div className="space-y-4">
              {[
                { icon: DollarSign, title: "New sale recorded", desc: "Order #1234 completed", time: "2 min ago", bg: "bg-green-50 dark:bg-green-900/20", color: "text-green-600 dark:text-green-400" },
                { icon: Users, title: "New user registered", desc: "john.doe@example.com joined", time: "5 min ago", bg: "bg-blue-50 dark:bg-blue-900/20", color: "text-blue-600 dark:text-blue-400" },
                { icon: Package, title: "Product updated", desc: "iPhone 15 Pro stock updated", time: "10 min ago", bg: "bg-purple-50 dark:bg-purple-900/20", color: "text-purple-600 dark:text-purple-400" },
                { icon: Activity, title: "System maintenance", desc: "Scheduled backup completed", time: "1 hour ago", bg: "bg-orange-50 dark:bg-orange-900/20", color: "text-orange-600 dark:text-orange-400" },
                { icon: Bell, title: "New notification", desc: "Marketing campaign results", time: "2 hours ago", bg: "bg-red-50 dark:bg-red-900/20", color: "text-red-600 dark:text-red-400" },
              ].map(({ icon: Icon, title, desc, time, bg, color }, i) => (
        ...
        <div className="space-y-6">
          <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-6 shadow-sm">
            ...
            <div className="space-y-4">
              {[
                { label: "Conversion Rate", value: "3.2%", width: "32%", color: "bg-blue-500" },
                { label: "Bounce Rate", value: "45%", width: "45%", color: "bg-orange-500" },
                { label: "Page Views", value: "8.7k", width: "87%", color: "bg-green-500" },
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-6 shadow-sm">
            ...
            <div className="space-y-3">
              {[
                { name: "iPhone 15 Pro", price: "$1,299" },
